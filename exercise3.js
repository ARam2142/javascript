...
// 7.b -After the numbers array has been cleaned up to only have numbers in it, Write a function that sorts the modified numbers array.  Allow the function to sort the array in descending order as well.
...
/************************************************************* */
//Bonus assignments:
// Bonus 1 - research a new feature of ES6+ and create an example of it's use case here.  Be sure to write comments explaining what the feature is and why it is useful.


///************************************************************* */
// Bonus 2: (This problem can be finished after it's covered in JavaScript IV content)
